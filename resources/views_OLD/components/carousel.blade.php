  ...
  @if (count($links) == 1)
      <figure class="max-w-lg">
        ...
        <figcaption class="mt-2 text-sm text-center text-white dark:text-gray-400">{{$post->caption}}</figcaption>
      </figure>
  @else
    ...
    <!-- Slider indicators -->
      ...
      <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
          <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-400 dark:bg-gray-800/30 group-hover:bg-gray-200 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
