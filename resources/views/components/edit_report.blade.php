                          ...
                          <div class="flex flex-col">
                              <div class="flex justify-between">
                                <div class="flex items-center justify-start relative pt-6 basis-1/2">
                                  <div class="absolute -top-3 left-1/2 -translate-x-1/2 text-lg text-gray-100">Sender</div>
                                  <img class="w-10 h-10 rounded-full" src="{{$default_img}}" alt="image" id="sender-image">
                                  <div class="ps-3">
                                      <div class="text-base font-semibold" id="sender-name"></div>
                                      <div class="font-normal text-gray-500" id="sender-email"></div>
                                  </div>  
                                </div>
                                <div class=" flex items-center justify-start relative pt-6 basis-1/2">
                                  <div class="absolute -top-3 left-1/2 -translate-x-1/2 text-lg text-gray-100">Offender</div>
                                  <img class="w-10 h-10 rounded-full" src="{{$default_img}}" alt="image" id="offender-image">
                                  <div class="ps-3">
                                      <div class="text-base font-semibold" id="offender-name"></div>
                                      <div class="font-normal text-gray-500" id="offender-email"></div>
                                  </div>  
                                </div>
                              </div>
                              <hr class="border-2 border-gray-600 rounded-md my-6">
                              <div class="flex flex-col">
                                <h2 class="text-gray-100 text-xl font-bold" id="report-content">Content is here.</h2>
                                <div class="flex flex-col">
                                  <p class="text-white my-2" id="rep-content-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde aliquid sit possimus in? Eos iste ullam earum reiciendis? Eaque, totam.</p>
