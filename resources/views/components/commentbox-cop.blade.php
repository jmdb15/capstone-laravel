...
<div class="card">
  <div class="title">
    ...
    <a href="/forum/{{$curqid}}">  
      <button type="button" class="text-black transition-all hover:bg-[#e1e1e1] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
          See more
