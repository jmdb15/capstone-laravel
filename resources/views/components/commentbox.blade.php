...
<div class="card" x-data="{opennew: false}">
  <div class="title">
    <a>  
      <button type="button" x-on:click="open2 = !open2" class="text-black transition-all focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text px-3 md:px-5 py-1.5 text-center inline-flex items-center">
          Comments
      </button>
    </a>
    <a href="/forum/{{$curqid}}" x-show="see">  
      <button type="button" class="text-black transition-all focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-3 md:px-5 py-1.5 text-center inline-flex items-center">
          See more
        ...
        <div class="box-container">
          ...
          <div>
            <div class="formatting">
              <button type="button" class="send" title="Send" id="send-{{$curqid}}" onclick="reactsubmit('comment', {{auth()->user()->id}}, '{{auth()->user()->name}}', {{$cid}}, {{$curqid}})">
