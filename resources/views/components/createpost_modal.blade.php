...
<!-- Main modal -->
<div id="create-post-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="create-post-modal">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <hr>
                <form class="space-y-6" action="/create-post/process" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div>
                    ...
                    <div class="flex items-center justify-center w-full flex-wrap gap-3" id="droppable" ondrop="handleDrop(event)" ondragover="allowDrop(event)">
                        <label id="for-dropzone" for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6"  id="image-container">
                            ...
                            <input id="dropzone-file" type="file" name="image[]" multiple class="hidden" onchange="displayImages()"/>
                        </label>
