            ...
            <div class="flex gap-1">
                <div class="flex items-center justify-between px-2 py-2 bg-white border-b-2 w-full">
                  <div class="flex gap-x-4">
                        <h2 class="text-4xl  text-gray-800">Officials</h2>
                      <button id="add-content" class="bg-blue-600 text-gray-100 rounded-md py-2 px-6 hover:brightness-110" data-modal-target="add-official-modal" data-modal-toggle="add-official-modal">Add</button>                
                  </div>
                ...
                <tbody>
                    @foreach($file->staff as $row)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td scope="col" class="px-6 py-4">
                                <a class="hover:underline font-medium cursor-pointer text-blue-600" data-modal-target="edit-official-modal" data-modal-toggle="edit-official-modal" 
                                onclick="editOfficial('{{$row->name}}','{{$row->position}}')">Edit</a>
                                <a class="hover:underline font-medium cursor-pointer text-md text-red-400" onclick="deleteOfficial('{{$row->name}}')" data-modal-target="confirmation-modal" data-modal-toggle="confirmation-modal">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
