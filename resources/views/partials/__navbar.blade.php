    ...
    <nav class="container relative flex flex-wrap items-center justify-between h-full mx-auto lg:justify-between xl:px-0" x-data="{openMobile: false, open: false}">
        ...
        <div class="hidden relative -translate-x-12 text-center lg:flex lg:items-center">
            <ul class="items-center justify-end flex-1 pt-6 lg:pt-0 list-reset lg:flex">
              <li class=" nav__item">
                <a href="/posts" class="inline-block px-4 py-2 transition-all hover:brightness-110 bg-violet-500 dark:text-gray-200 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none">
              ...
              <li class=" nav__item">
                <a href="/forum" class="inline-block px-4 py-2 transition-all hover:brightness-110 bg-violet-500 dark:text-gray-200 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none">
