...
<body class="bg-gray-200" x-data="{nos: false}" :class="{'no-scroll': nos}">
  ...
  <button data-popover-target="popover-default" id="popbtn" type="button" class="hidden ml-96 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Default popover</button>
