...
class UserController extends Controller
{
    ...
    public function forum(){
        ...
        $notifs = $this->notifs();
        // dd($posts);
        return view('students.query', ['posts'=>$posts, 'open'=>'false', 'notifs' => $notifs]);
    }
    ...
    public function viewQuery($id){
        ...
        $notifs = $this->notifs();
        return view('students.query',['posts'=>$posts, 'open'=>'true', 'notifs' => $notifs]);
    }
    ...
    public function viewProfile($id){
        ...
        $user = Users::find($id);
        $notifs = $this->notifs();
        return view('students.profile', ['posts'=>$posts, 'user'=>$user, 'notifs' => $notifs]);
    }
